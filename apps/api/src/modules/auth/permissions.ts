...
export const PERMISSIONS: PermissionDef[] = [
  ...
  { code: 'sales.quotes.view', name: 'View quotes', module: 'sales' },
  { code: 'sales.quotes.create', name: 'Create quotes', module: 'sales' },
  { code: 'sales.quotes.update', name: 'Update quotes', module: 'sales' },
  { code: 'sales.quotes.approve', name: 'Approve quotes', module: 'sales' },
  { code: 'sales.quotes.cancel', name: 'Cancel quotes', module: 'sales' },
  ...
  { code: 'sales.invoices.update', name: 'Update invoices', module: 'sales' },
  { code: 'sales.invoices.post', name: 'Post invoices', module: 'sales' },
  { code: 'sales.invoices.void', name: 'Void invoices', module: 'sales' },
...
export const ROLE_DEFS: RoleDef[] = [
  ...
  { name: 'Sales Clerk', description: 'Quotes, orders, invoices', permissions: [
    'sales.quotes.manage', 'sales.quotes.view', 'sales.quotes.create', 'sales.quotes.update', 'sales.quotes.cancel',
    'sales.quotes.convert_order', 'sales.quotes.convert_invoice',
    'sales.orders.view', 'sales.orders.create', 'sales.orders.edit',
    'sales.invoices.view', 'sales.invoices.create', 'sales.invoices.update',
    'sales.delivery.manage', 'sales.deliveries.view', 'sales.deliveries.create',
    'sales.customers.view', 'crm.view',
  ] },
